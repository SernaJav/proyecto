                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input
                                                    ...
                                                    value="{{ old('fecha', $ordencompra->fecha ? $ordencompra->fecha->format('Y-m-d\TH:i') : '') }}"
                                                    required
                                                >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input
                                                    ...
                                                    value="{{ old('precio', $detalle ? round($detalle->subtotal / ($detalle->cantidad ?: 1), 2) : 0) }}"
                                                    readonly
                                                    required
                                                >
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input
                                                    ...
                                                    id="subtotal"
                                                    class="form-control modern-input"
                                                    value="{{ old('subtotal', $detalle->subtotal ?? 0) }}"
                                                    readonly
                                                >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                >
                                                    ...
                                                    <option value="contado" {{ old('tipopago', $ordencompra->tipopago) == 'contado' ? 'selected' : '' }}>Contado</option>
                                                    <option value="credito" {{ old('tipopago', $ordencompra->tipopago) == 'credito' ? 'selected' : '' }}>Crédito</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="input-group">
                                                ...
                                                >
                                                    ...
                                                    @foreach($metodospago as $metodo)
                                                        <option
                                                            value="{{ $metodo->id }}"
                                                            {{ old('metodopago_id', $ordencompra->pagos->first()?->metodopago_id) == $metodo->id ? 'selected' : '' }}
                                                        >
                                                            {{ $metodo->nombre }}
                                                        </option>
                                                    @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input
                                                    ...
                                                    id="abono"
                                                    class="form-control modern-input"
                                                    value="{{ old('abono', $ordencompra->pagos->first()?->monto ?? 0) }}"
                                                    min="0"
                                                    required
                                                >
                                            </div>
